...
Процедура Тест_ДолженОбработатьИзмененияИзГитДляКаталогаСВложеннымиКаталогами() Экспорт
	...
	КаталогВыгрузкиИсходников = ОбъединитьПути(КаталогВыгрузки, "src");
	...
	ПутьКаталогаВыгрузкиДляОбработки = ОбъединитьПути(КаталогВыгрузкиИсходников, ИмяВложенногоКаталога, ФайлОбработки.ИмяБезРасширения);
	Ожидаем.Что(КаталогСодержитИсходникиОбработки(ПутьКаталогаВыгрузкиДляОбработки), "ожидаем, что КаталогСодержитИсходникиОбработки(ПутьКаталогаВыгрузкиДляОбработки) это Истина").ЭтоИстина();
...
Процедура ДобавитьЛогФайлОтладки()
	// Возврат;
	...
	Лог.Отладка("Перед ВыводЛогаВФайл.ОткрытьФайл(ПутьЛога) "+ПутьЛога);
	ВыводЛогаВФайл.ОткрытьФайл(ПутьЛога);
	Сообщить("После ВыводЛогаВФайл.ОткрытьФайл(ПутьЛога) "+ПутьЛога);
	Лог.Отладка("После ВыводЛогаВФайл.ОткрытьФайл(ПутьЛога) "+ПутьЛога);
	Лог.ДобавитьСпособВывода(ВыводЛогаВФайл);
	Лог.Отладка("Лог.ДобавитьСпособВывода(ВыводЛогаВФайл) "+ПутьЛога);
